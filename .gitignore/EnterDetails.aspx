<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation_Layer/Site1.Master" AutoEventWireup="true" CodeBehind="EnterDetails.aspx.cs" Inherits="SLKUniversity.Presentation_Layer.WebForm5" %>
    ...
    <table style="position:relative;top:50px;left:500px;" >       
        <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="FirstName" runat="server" Height="35px" Width="225px" placeholder="Enter Your FirstName"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="LastName" runat="server" Height="35px" Width="225px" placeholder="Enter Your LastName"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="PhoneNumber" runat="server" Height="35px" Width="225px" placeholder="Enter PhoneNumber"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
         ...
         <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="Address" runat="server" Height="35px" Width="225px" placeholder="Enter Address" TextMode="MultiLine"></asp:TextBox>
            </td>
             <td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="City" runat="server" Height="35px" Width="225px" placeholder="Enter city"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="State" runat="server" Height="35px" Width="225px" placeholder="Enter State"></asp:TextBox>
            </td>
            <td>
         ...
         <tr>
            ...
            <td class="auto-style1">
                <asp:TextBox ID="Country" runat="server" Height="35px" Width="225px" placeholder="Enter Country"></asp:TextBox>
            </td>
             <td>
         ...
         <tr>
            ...
            <td class="auto-style1">
             ...
             <td>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="Gender" ErrorMessage="*Please select your gender" ForeColor="Red"></asp:RequiredFieldValidator>
             </td>
        </tr>
         <tr>
            <td>
